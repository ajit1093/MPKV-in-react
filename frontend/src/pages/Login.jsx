  ...
  return (
    <PublicLayout>
      <div className="bg-gray-50 py-10 px-4 min-h-[60vh] flex items-center justify-center">
        ...
        {/* Card — matches old login-card design exactly */}
          ...
          <div className="px-7 pt-5 pb-4">
            ...
            <form onSubmit={handleSubmit} noValidate className="space-y-4">
              ...
              <div>
                ...
                <div className="relative">
                  ...
                  <input
                    ...
                    className="w-full pl-9 pr-3 py-2.5 border-[1.5px] border-emerald-100 rounded-lg text-sm text-gray-900
                               bg-emerald-50 placeholder-gray-400
                               focus:outline-none focus:border-emerald-500 focus:ring-2 focus:ring-emerald-500/20 focus:bg-white transition"
                  />
                </div>
              </div>
              ...
              <div>
                ...
                <div className="relative">
                  ...
                  <input
                    ...
                    onChange={handleChange}
                    className="w-full pl-9 pr-10 py-2.5 border-[1.5px] border-emerald-100 rounded-lg text-sm text-gray-900
                               bg-emerald-50 placeholder-gray-400
                               focus:outline-none focus:border-emerald-500 focus:ring-2 focus:ring-emerald-500/20 focus:bg-white transition"
                  />
                  <button
              ...
              <div className="flex justify-between text-[12.5px]">
                <Link to="/forgot-login-id" className="text-emerald-600 font-medium hover:underline">
                  Forgot Login ID?
                </Link>
